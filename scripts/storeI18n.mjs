...
export const I18N_STRINGS = {
  "ar": {
    ...
    "insufficient_funds_desc": "💡 <i>الحد الأدنى لشحن المحفظة هو <code>5.00$ USDT</code>. يمكنك شحن محفظتك الآن، وسيتم خصم سعر المنتج وتفعيله فوراً، ويتبقى باقي الرصيد في محفظتك لاستخدامه في أي وقت!</i>",
  ...
  "en": {
    ...
    "insufficient_funds_desc": "💡 <i>Minimum wallet top-up is <code>.00 USDT</code>. Top up now to activate your product instantly with remaining balance kept in your wallet!</i>",
  ...
  "es": {
    ...
    "insufficient_funds_desc": "💡 <i>La recarga mínima es de <code>.00 USDT</code>. ¡Recargue ahora para activar su producto al instante y conserve el saldo restante!</i>",
  ...
  "fr": {
    ...
    "insufficient_funds_desc": "💡 <i>La recharge minimale est de <code>.00 USDT</code>. Rechargez maintenant pour activer votre produit immédiatement et conservez le solde restant !</i>",
  ...
  "ru": {
    ...
    "insufficient_funds_desc": "💡 <i>Минимальная сумма пополнения — <code>.00 USDT</code>. Пополните счет сейчас, чтобы мгновенно активировать подписку!</i>",
  ...
  "tr": {
    ...
    "insufficient_funds_desc": "💡 <i>Minimum yükleme tutarı <code>.00 USDT</code>'dir. Ürününüzü anında etkinleştirmek için şimdi yükleyin!</i>",
  ...
  "de": {
    ...
    "insufficient_funds_desc": "💡 <i>Die Mindestaufladung beträgt <code>.00 USDT</code>. Laden Sie jetzt auf, um Ihr Produkt sofort zu aktivieren!</i>",
